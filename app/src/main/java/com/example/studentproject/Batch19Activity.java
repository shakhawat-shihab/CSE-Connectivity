...
public class Batch19Activity extends AppCompatActivity {
    private RecyclerView RV;
    private ProgressBar PB;
    DatabaseHelper19 databaseHelper_19;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch19);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("19th Batch");
        userList=new ArrayList<>();
        PB=findViewById(R.id.batch_19_progress_bar);
        PB.setVisibility(View.GONE);
        databaseHelper_19=new DatabaseHelper19(this);
        RV=findViewById(R.id.recycler_id_19);
    ...
    private void showAll() {
        Cursor c = databaseHelper_19.showAllData_s_22();
        while (c.moveToNext()) {
        ...
        Cursor cc = databaseHelper_19.showAllData_s_21();
        while (cc.moveToNext()) {
        ...
        Cursor d = databaseHelper_19.showAllData_s_20();
        while (d.moveToNext()) {
        ...
        Cursor e = databaseHelper_19.showOther();
        while (e.moveToNext()) {
        ...
        myAdapter = new MyAdapter(Batch19Activity.this, userList);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Batch19Activity.this, ShowInfoActivity.class);
