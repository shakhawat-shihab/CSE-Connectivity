...
public class DatabaseHelper16 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME="student.db";
    private static final String TABLE_NAME="Batch_16";
    ...
    private static final String SORT_ALL_18="select * from "+TABLE_NAME+" where "+C1+" like 'CE18___' "+ " order by "+C1+" ASC;";
    private static final String OTHER="select * from "+TABLE_NAME+" where "+C1+" not like 'CE17___'  and "+ C1+" not like 'CE19___'  and " +C1+" not like 'CE18___';";
    private static final String SORT_ALL="select * from "+TABLE_NAME+" order by "+C1+" ASC;";
    private static final int VERSION_NUMBER=1;
    private Context context;

    public DatabaseHelper16(@Nullable Context context) {
    ...
    public Cursor showAllData_s_18()
    {
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        Cursor c=sqLiteDatabase.rawQuery(SORT_ALL_18,null);
        return c;
    }
