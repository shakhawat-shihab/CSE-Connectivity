...
public class Batch18Activity extends AppCompatActivity {
    private RecyclerView RV;
    private ProgressBar PB;
    DatabaseHelper18 databaseHelper_18;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch18);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("18th Batch");
        userList=new ArrayList<>();
        PB=findViewById(R.id.batch_18_progress_bar);
        PB.setVisibility(View.GONE);
        databaseHelper_18=new DatabaseHelper18(this);
        RV=findViewById(R.id.recycler_id_18);
    ...
    private void showAll() {
        Cursor c = databaseHelper_18.showAllData_s_21();
        while (c.moveToNext()) {
        ...
        Cursor cc = databaseHelper_18.showAllData_s_20();
        while (cc.moveToNext()) {
        ...
        Cursor d = databaseHelper_18.showAllData_s_19();
        while (d.moveToNext()) {
        ...
        Cursor e = databaseHelper_18.showOther();
        while (e.moveToNext()) {
        ...
        myAdapter = new MyAdapter(Batch18Activity.this, userList);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Batch18Activity.this, ShowInfoActivity.class);
