...
public class DatabaseHelper17 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME="student.db";
    private static final String TABLE_NAME="Batch_17";
    ...
    private static final String OTHER="select * from "+TABLE_NAME+" where "+C1+" not like 'CE18___'  and "+ C1+" not like 'CE19___'  and " +C1+" not like 'CE20___';";
    private static final String SORT_ALL="select * from "+TABLE_NAME+" order by "+C1+" ASC;";
    private static final int VERSION_NUMBER=1;
    private Context context;

    public DatabaseHelper17(@Nullable Context context) {
