...
public class Batch15Activity extends AppCompatActivity {
    private RecyclerView RV;
    private ProgressBar PB;
    DatabaseHelper15 databaseHelper_15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch15);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("15th Batch");
        userList=new ArrayList<>();
        PB=findViewById(R.id.batch_15_progress_bar);
        PB.setVisibility(View.GONE);
        databaseHelper_15=new DatabaseHelper15(this);
        RV=findViewById(R.id.recycler_id_15);
    ...
    private void showAll() {
        Cursor c = databaseHelper_15.showAllData_s_18();
        while (c.moveToNext()) {
        ...
        Cursor cc = databaseHelper_15.showAllData_s_17();
        while (cc.moveToNext()) {
        ...
        Cursor d = databaseHelper_15.showAllData_s_16();
        while (d.moveToNext()) {
        ...
        Cursor e = databaseHelper_15.showOther();
        while (e.moveToNext()) {
        ...
        myAdapter = new MyAdapter(Batch15Activity.this, userList);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Batch15Activity.this, ShowInfoActivity.class);
