...
public class Batch13Activity extends AppCompatActivity {
    private RecyclerView RV;
    private ProgressBar PB;
    DatabaseHelper13 databaseHelper_13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch13);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("13th Batch");
        userList=new ArrayList<>();
        PB=findViewById(R.id.batch_13_progress_bar);
        PB.setVisibility(View.GONE);
        databaseHelper_13=new DatabaseHelper13(this);
        RV=findViewById(R.id.recycler_id_13);
    ...
    private void showAll() {
        Cursor c = databaseHelper_13.showAllData_s_16();
        while (c.moveToNext()) {
        ...
        Cursor cc = databaseHelper_13.showAllData_s_15();
        while (cc.moveToNext()) {
        ...
        Cursor d = databaseHelper_13.showAllData_s_14();
        while (d.moveToNext()) {
        ...
        Cursor e = databaseHelper_13.showOther();
        while (e.moveToNext()) {
        ...
        myAdapter = new MyAdapter(Batch13Activity.this, userList);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Batch13Activity.this, ShowInfoActivity.class);
