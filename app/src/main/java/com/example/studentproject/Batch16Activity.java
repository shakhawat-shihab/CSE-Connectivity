...
public class Batch16Activity extends AppCompatActivity {
    private RecyclerView RV;
    private ProgressBar PB;
    DatabaseHelper16 databaseHelper_16;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch16);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        setTitle("16th Batch");
        userList=new ArrayList<>();
        PB=findViewById(R.id.batch_16_progress_bar);
        PB.setVisibility(View.GONE);
        databaseHelper_16=new DatabaseHelper16(this);
        RV=findViewById(R.id.recycler_id_16);
    ...
    private void showAll() {
        Cursor c = databaseHelper_16.showAllData_s_19();
        while (c.moveToNext()) {
        ...
        Cursor cc = databaseHelper_16.showAllData_s_18();
        while (cc.moveToNext()) {
        ...
        Cursor d = databaseHelper_16.showAllData_s_17();
        while (d.moveToNext()) {
        ...
        Cursor e = databaseHelper_16.showOther();
        while (e.moveToNext()) {
        ...
        myAdapter = new MyAdapter(Batch16Activity.this, userList);
        ...
        myAdapter.setOnItemClickListener(new MyAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Batch16Activity.this, ShowInfoActivity.class);
