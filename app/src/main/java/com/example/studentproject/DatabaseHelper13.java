...
public class DatabaseHelper13 extends SQLiteOpenHelper {
    ...
    private static final String TABLE_NAME="Batch_13";
    ...
    private static final String SORT_ALL_14="select * from "+TABLE_NAME+" where "+C1+" like 'CE14___' "+ " order by "+C1+" ASC;";
    private static final String OTHER="select * from "+TABLE_NAME+" where "+C1+" not like 'CE16___'  and "+ C1+" not like 'CE15___'  and " +C1+" not like 'CE14___';";
    ...
    public Cursor showAllData_s_14()
    {
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        Cursor c=sqLiteDatabase.rawQuery(SORT_ALL_14,null);
        return c;
    }
