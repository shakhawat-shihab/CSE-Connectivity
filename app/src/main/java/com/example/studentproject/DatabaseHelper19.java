...
public class DatabaseHelper19 extends SQLiteOpenHelper {
    private static final String DATABASE_NAME="student.db";
    private static final String TABLE_NAME="Batch_19";
    ...
    private static final String SORT_ALL_22="select * from "+TABLE_NAME+" where "+C1+" like 'CE22___' "+ " order by "+C1+" ASC;";
    ...
    private static final String OTHER="select * from "+TABLE_NAME+" where "+C1+" not like 'CE21___'  and "+ C1+" not like 'CE22___'  and " +C1+" not like 'CE20___';";
    private static final String SORT_ALL="select * from "+TABLE_NAME+" order by "+C1+" ASC;";
    private static final int VERSION_NUMBER=1;
    private Context context;

    public DatabaseHelper19(@Nullable Context context) {
    ...
    public Cursor showAllData_s_22()
    {
        SQLiteDatabase sqLiteDatabase=this.getWritableDatabase();
        Cursor c=sqLiteDatabase.rawQuery(SORT_ALL_22,null);
        return c;
    }
